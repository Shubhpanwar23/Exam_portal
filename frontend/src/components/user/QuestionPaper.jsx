                ...
                <div className='item-1'>
                    <div className='innerGridComponent'>
                        {questionData.map((question,index1)=>(
                            <a style={{textDecoration:'none',color:'black'}} href={`#${index1}`} key={question.queId}><div className='box' >{++index1}</div></a>
                        ))}
                    </div>
                </div>
                <div className='item-2'>
                    {questionData.map((question,index) => (
                        <div key={question.queId} style={{ marginBottom: '30px', boxShadow: ' 10px 10px 25px grey' }}>
                            <Card>
